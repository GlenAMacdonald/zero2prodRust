...
impl TestApp {
    // Our tests will only look at the HTML, so get it.
        ...
        Body: serde::Serialize,
    {
        self.api_client
            ...
            // This reqwest method makes sure the body is URL-encoded and the Content-Type header is set accordingly
            .form(body)
            .send()
            .await
            .expect("Failed to execute request.")
...
pub async fn spawn_app() -> TestApp {
    ...
    // All other invokations will instead skip execution
    Lazy::force(&TRACING);
