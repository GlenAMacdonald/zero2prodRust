...
mod tests {
    ...
    async fn send_email_send_the_expected_request() {
        ...
        Mock::given(header_exists("X-Postmark-Server-Token"))
            ...
            .expect(1)
            .mount(&configured_mock.mock_server)
            .await;

        let _ = configured_mock.email_client
            .send_email(&configured_mock.subscriber_email, &subject(), &content(), &content())
            .await;
    }
    ...
    async fn send_email_succeeds_if_the_server_returns_200() {
        ...
        let outcome = configured_mock.email_client
            .send_email(&configured_mock.subscriber_email, &subject(), &content(), &content())
            .await;
